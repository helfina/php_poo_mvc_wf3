...
class Bdd extends Database
{
     ...
     * @param Bdd $model Objet à créer
     * @return bool
     */
    public function create(Bdd $model)
    {
        $champs = [];
        $inter = [];
        $valeurs = [];
     ...
     * @param Bdd $model Objet à modifier
     * @return bool
     */
    public function update(int $id, Bdd $model)
    {
        $champs = [];
        $valeurs = [];
